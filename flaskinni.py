import os # give me tools to get my own IP and my computer
from dotenv import load_dotenv # connect me with any .env fils
from flask_security import utils # a tool to encrypt password
...
import sys 
import click # lets me use "flask ..." commands
